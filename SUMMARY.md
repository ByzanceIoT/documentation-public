...
* [Programování HW](hardware-a-programovani/programovani-hw/README.md)
  ...
  * [Byzance API](hardware-a-programovani/programovani-hw/byzance-hardware-api/README.md)
    * [Vstupy a výstupy do Portálu](hardware-a-programovani/programovani-hw/byzance-hardware-api/vstupy-a-vystupy-do-portalu.md)
    * [Callback Busy](hardware-a-programovani/programovani-hw/byzance-hardware-api/callback-busy.md)
    * [Odložený restart](hardware-a-programovani/programovani-hw/byzance-hardware-api/odlozeny-restart.md)
    * [Callbacky připojení](hardware-a-programovani/programovani-hw/byzance-hardware-api/callbacky.md)
    * [Uživatelská makra](hardware-a-programovani/programovani-hw/byzance-hardware-api/uzivatelska-makra.md)
...
* Správa a diagnostika
  * [LED modul](hardware-a-programovani/sprava-zarizeni/led-modul.md)
